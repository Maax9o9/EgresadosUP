...
const TableFilter: FunctionComponent<TableFilterProps> = ({ 
  ...
  const hasActiveFilters = searchTerm || selectedCareer || selectedDate || sortBy !== "newest";
    ...
    <div className="w-full bg-white border border-gray-200 rounded-xl shadow-sm relavite">
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="relative">
          <div className="flex items-center border-2 border-gray-300 rounded-lg px-3 sm:px-4 h-12 bg-white focus-within:border-[#8DD2FF] focus-within:ring-2 focus-within:ring-[#8DD2FF]/20 transition-all">
            <Search className="text-gray-400 w-5 h-5 mr-2 sm:mr-3 flex-shrink-0" />
            <input
              type="text"
              value={searchTerm}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div>
            ...
            >
              ...
              <option value="ITIID2">ITIID2</option>
              <option value="LAGUE">LAGUE</option>
