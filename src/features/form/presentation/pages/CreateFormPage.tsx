        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-7xl mx-auto">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <p className="mt-1 text-sm sm:text-base text-gray-600">
              Selecciona una opción para comenzar a diseñar tu formulario
            </p>
          </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Diseña un formulario completamente personalizado. Agrega preguntas y configura cada detalle según tus necesidades.
                  </p>
                  <div className="inline-flex items-center gap-2 text-sm font-medium text-[#8DD2FF] group-hover:gap-3 transition-all">
                    Iniciar editor
                    <ArrowRightIcon className="h-4 w-4" />
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-blue-800">
                  Las preguntas copiadas desde un formulario existente no afectarán al formulario original. Puedes modificarlas libremente en tu formulario.
                </p>
              </div>
            </div>
          </div>
